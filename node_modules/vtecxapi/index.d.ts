...
declare namespace vtecxapi {
    ...
    function deleteUser(feed: any): any;
    ...
    function getSessionString(name: string): string;
    ...
    function deleteSessionString(name: string): void;
    ...
    function postBQ(request: any, async: boolean, tablenames?: any): void;
    function deleteBQ(keys: string[], async: boolean, tablenames?: any): void;
